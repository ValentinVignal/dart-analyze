...
describe('ActionOptions', () => {
    ...
    beforeEach(() => {
        ...
        vi.spyOn(path, 'resolve').mockImplementation((base, relative) => {
            if (relative === './') {
    ...
    describe('applyDefaults function', () => {
        ...
        it('should resolve working directory with custom path', () => {
            ...
            applyDefaults(options);
            expect(path.resolve).toHaveBeenCalledWith('/github/workspace', 'src/dart');
        });
        ...
        it('should handle complex working directory paths', () => {
            ...
            expect(path.resolve).toHaveBeenCalledWith('/github/workspace', '../parent/child/subdir');
        });
    ...
    describe('Type definitions', () => {
        ...
        it('should ensure ActionOptions allows partial properties', () => {
            ...
            const option1 = { token: 'test' };
            const option2 = { token: 'test', emojis: false };
            const option3 = {
                token: 'test',
                failOn: FailOnEnum.Error,
            };
...
//# sourceMappingURL=ActionOptions.test.js.map