...
---
- :poop: :eyes: Info - \`lib/file1.dart\`:1:1 - Info message for file 1, hunk 1. (error_code_0). See [link](https://dart.dev/diagnostic/error_code_0) or [link](https://dart.dev/lints/error_code_0).
- :poop: :eyes: Info - \`lib/file1.dart\`:20:1 - Info message for file 1, hunk 2. (error_code_2). See [link](https://dart.dev/diagnostic/error_code_2) or [link](https://dart.dev/lints/error_code_2).
- :x: :warning: **Warning - \`lib/file1.dart\`:2:1 - Warning message for file 1, hunk 1. (error_code_4).** See [link](https://dart.dev/diagnostic/error_code_4) or [link](https://dart.dev/lints/error_code_4).
- :x: :warning: **Warning - \`lib/file1.dart\`:21:1 - Warning message for file 1, hunk 2. (error_code_6).** See [link](https://dart.dev/diagnostic/error_code_6) or [link](https://dart.dev/lints/error_code_6).
- :x: :bangbang: **Error - \`lib/file1.dart\`:3:1 - Error message for file 1, hunk 1. (error_code_8).** See [link](https://dart.dev/diagnostic/error_code_8) or [link](https://dart.dev/lints/error_code_8).
- :x: :bangbang: **Error - \`lib/file1.dart\`:22:1 - Error message for file 1, hunk 2. (error_code_10).** See [link](https://dart.dev/diagnostic/error_code_10) or [link](https://dart.dev/lints/error_code_10).
- :poop: :eyes: Info - \`lib/file2.dart\`:50:1 - Info message for file 2, hunk 1. (error_code_13). See [link](https://dart.dev/diagnostic/error_code_13) or [link](https://dart.dev/lints/error_code_13).
- :poop: :eyes: Info - \`lib/file2.dart\`:200:1 - Info message for file 2, hunk 2. (error_code_15). See [link](https://dart.dev/diagnostic/error_code_15) or [link](https://dart.dev/lints/error_code_15).
- :x: :warning: **Warning - \`lib/file2.dart\`:51:1 - Warning message for file 2, hunk 1. (error_code_18).** See [link](https://dart.dev/diagnostic/error_code_18) or [link](https://dart.dev/lints/error_code_18).
- :x: :warning: **Warning - \`lib/file2.dart\`:201:1 - Warning message for file 2, hunk 2. (error_code_20).** See [link](https://dart.dev/diagnostic/error_code_20) or [link](https://dart.dev/lints/error_code_20).
- :x: :bangbang: **Error - \`lib/file2.dart\`:52:1 - Error message for file 2, hunk 1. (error_code_23).** See [link](https://dart.dev/diagnostic/error_code_23) or [link](https://dart.dev/lints/error_code_23).
- :x: :bangbang: **Error - \`lib/file2.dart\`:202:1 - Error message for file 2, hunk 2. (error_code_25).** See [link](https://dart.dev/diagnostic/error_code_25) or [link](https://dart.dev/lints/error_code_25).
---
- :poop:  \`lib/file1.dart\` is not formatted.`,
    ...
    expect(vi.mocked(console.log).mock.calls).toEqual(
      [
        ...
        '::WARNING file=lib/file1.dart,line=1,col=1::Info message for file 1, hunk 1. (error_code_0) See https://dart.dev/diagnostic/error_code_0 or https://dart.dev/lints/error_code_0',
        '::WARNING file=lib/file1.dart,line=20,col=1::Info message for file 1, hunk 2. (error_code_2) See https://dart.dev/diagnostic/error_code_2 or https://dart.dev/lints/error_code_2',
        ...
        '::WARNING file=lib/file2.dart,line=200,col=1::Info message for file 2, hunk 2. (error_code_15) See https://dart.dev/diagnostic/error_code_15 or https://dart.dev/lints/error_code_15',
